...
tmux split-window -dh "${venv} python3 -u src/very_small_with_fc.py | tee results/train_very_small_with_fc-${timestamp}.log"
...
tmux split-window -dh "${venv} python3 -u src/alex_net.py | tee results/train_alex_net-${timestamp}.log"
